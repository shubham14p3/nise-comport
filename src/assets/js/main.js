; (function ($) {
	...
	var selectedNightTheme = sessionStorage.getItem("body_dark");
	...
	$('#something').change(function () {
		if ($(this).is(':checked')) {
			applyNight();
			sessionStorage.setItem("body_dark", true);
		} else {
			applyDay();
			sessionStorage.setItem("body_dark", false);
		}
	});
	...
	$('a[href^="#"]').on('click', function (e) {
        ...
        if (targetElement.length) {
            var offset = 10; // Sticky header height
            var scrollTop = targetElement.offset().top - offset;
