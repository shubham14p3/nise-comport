...
export default function Menu() {
    ...
    const { setIsSearch, setIsMobile, activeSection, scrollToSection } = context;
                ...
                <div className="main-menu-two__wrapper-inner">
                    ...
                    <div className="main-menu-two__main-menu-box">
                        ...
                        <ul className="main-menu__list one-page-scroll-menu">
                            ...
                            <li className={`scrollToLink ${activeSection === 'testimonial' ? 'current' : ''}`}>
                                <a href="#testimonial" onClick={(e) => { e.preventDefault(); scrollToSection('testimonial'); }}>Testimonial</a>
                            </li>
